...
import Cbsoriginal from '../../assets/cbs_original.png'
export default function SerieBanner(){
 
return(
<>
<div className="w-screen flex flex-col justify-end">
<img className='relative w-full min-h-[565px] max-h-[600px] h-full md:h-3/4 brightness-75 ' src={imgserie} alt="ncisbanner" />
<div className='absolute z-10 mx-5 md:mx-10 xl:mx-24 mb-10 '>
    ...
    <img className='max-w-36'  src={Cbsoriginal} alt="" />
    </div>
    </div>
    </div> 
