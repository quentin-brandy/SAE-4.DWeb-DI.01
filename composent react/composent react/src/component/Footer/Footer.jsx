...
export default function Footer() {
  ...
  <br/> <a class=" text-sm flex justify-center" href="#">| Gérer les cookies</a>
        ...
        <ul class="flex justify-center items-center gap-8">
            <li>
                <a href="#">
                    <img class="w-5 h-auto" src={facebook} alt="facebook"/>
                </a>
            </li>
            <li>
                <a href="#">
                    <img class="w-5 h-auto" src={twitter} alt="twitter"/>
                </a>
            </li>
            <li>
                <a href="#">
                    <img class="w-5 h-auto" src={youtube} alt="youtube"/>
                </a>
            </li>
            <li>
                <a href="#">
                    <img class="w-5 h-auto" src={instagram} alt="instagam"/>
                </a>
            </li>
        </ul>
        ...
        <img class="ml-4 pb-2" src={logo} alt="logo cbs"/>
        <div class="flex justify-start items-start gap-40 mt-2 ml-4">
           ...
           <li>
            <ul class="flex  items-center justify-center gap-8">
                <li>
                    <a href="#">
                        <img class="w-6 h-auto" src={facebook} alt="facebook"/>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img class="w-6 h-auto" src={twitter} alt="twitter"/>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img class="w-6 h-auto" src={youtube} alt="youtube"/>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img class="w-6 h-auto" src={instagram} alt="instagam"/>
                    </a>
                </li>
            </ul>
            </li>
